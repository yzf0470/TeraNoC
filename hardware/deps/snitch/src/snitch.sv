...
`ifdef TARGET_SPATZ
          ...
          riscv_instr::CSR_VCSR: begin
            if (RVV) begin
              ...
              illegal_inst = 1'b1;              $display("error occur 7");
...
`ifdef TARGET_SPATZ
      ...
      riscv_instr::VSETVLI: begin
        if (RVV) begin
          ...
          illegal_inst = 1'b1;$display("error occur 10");
        end
      end
      ...
      riscv_instr::VSETVL: begin
        if (RVV) begin
          ...
          illegal_inst = 1'b1;$display("error occur 11");
        end
      end
      ...
      riscv_instr::VMV_X_S: begin
        if (RVV) begin
          ...
          illegal_inst = 1'b1;$display("error occur 12");
        end
      end
      ...
      riscv_instr::VSLIDEDOWN_VI: begin
        if (RVV) begin
          ...
          illegal_inst = 1'b1;$display("error occur 13");
        end
      end
      ...
      riscv_instr::VFWNMSAC_VV: begin
        if (RVV && RVF) begin
          ...
          illegal_inst = 1'b1;$display("error occur 14");
        end
      end
      ...
      riscv_instr::VSLIDE1DOWN_VX: begin
        if (RVV) begin
          ...
          illegal_inst = 1'b1;$display("error occur 15");
        end
      end
      ...
      riscv_instr::VFWNMSAC_VF: begin
        if (RVV && RVF) begin
          ...
          illegal_inst = 1'b1;$display("error occur1 6");
        end
      end
      riscv_instr::VLE8_V,
      riscv_instr::VLE16_V,
      ...
      riscv_instr::VLUXEI64_V: begin
        if (RVV) begin
          ...
          illegal_inst = 1'b1;$display("error occur 17");
        end
      end
      ...
      riscv_instr::VSUXEI64_V: begin
        if (RVV) begin
          ...
          illegal_inst = 1'b1;$display("error occur18 ");
        end
      end
      ...
      riscv_instr::VLSE64_V: begin
        if (RVV) begin
          ...
          illegal_inst = 1'b1;$display("error occu19r ");
        end
      end
      ...
      riscv_instr::VSSE64_V: begin
        if (RVV) begin
          ...
          illegal_inst = 1'b1;$display("error occur20 ");
        end
      end
`endif
...
`ifdef XPULPIMG_EXTENSION
      ...
      riscv_instr::P_LBU_IRPOST: begin // Xpulpimg: p.lbu
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error occur22 ");
        end
      end
      riscv_instr::P_LH_IRPOST: begin  // Xpulpimg: p.lh
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error occur 23");
        end
      end
      riscv_instr::P_LHU_IRPOST: begin // Xpulpimg: p.lhu
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error occur 24");
        end
      end
      riscv_instr::P_LW_IRPOST: begin  // Xpulpimg: p.lw
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error o25ccur ");
        end
      end
      riscv_instr::P_LB_RRPOST: begin  // Xpulpimg: p.lb rd,rs2(rs1!)
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error o26ccur ");
        end
      end
      riscv_instr::P_LBU_RRPOST: begin // Xpulpimg: p.lbu
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("err27or occur ");
        end
      end
      riscv_instr::P_LH_RRPOST: begin  // Xpulpimg: p.lh
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("erro28r occur ");
        end
      end
      riscv_instr::P_LHU_RRPOST: begin // Xpulpimg: p.lhu
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error occur29 ");
        end
      end
      riscv_instr::P_LW_RRPOST: begin  // Xpulpimg: p.lw
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error occu30r ");
        end
      end
      riscv_instr::P_LB_RR: begin      // Xpulpimg: p.lb rd,rs2(rs1)
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error occu31r ");
        end
      end
      riscv_instr::P_LBU_RR: begin     // Xpulpimg: p.lbu
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error o32ccur ");
        end
      end
      riscv_instr::P_LH_RR: begin      // Xpulpimg: p.lh
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error occu33r ");
        end
      end
      riscv_instr::P_LHU_RR: begin     // Xpulpimg: p.lhu
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error occ34ur ");
        end
      end
      riscv_instr::P_LW_RR: begin      // Xpulpimg: p.lw
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error occur35 ");
        end
      end
      riscv_instr::P_SB_IRPOST: begin  // Xpulpimg: p.sb rs2,simm(rs1!)
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error o36ccur ");
        end
      end
      riscv_instr::P_SH_IRPOST: begin  // Xpulpimg: p.sh
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error 37occur ");
        end
      end
      riscv_instr::P_SW_IRPOST: begin  // Xpulpimg: p.sw
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error 38occur ");
        end
      end
      ...
      riscv_instr::P_SB_RRPOST: begin  // Xpulpimg: p.sb rs2,rs3(rs1!)
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error o39ccur ");
        end
      end
      riscv_instr::P_SH_RRPOST: begin  // Xpulpimg: p.sh
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error occur40 ");
        end
      end
      riscv_instr::P_SW_RRPOST: begin  // Xpulpimg: p.sw
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error occur41 ");
        end
      end
      riscv_instr::P_SB_RR: begin      // Xpulpimg: p.sb rs2,rs3(rs1)
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error occur 42");
        end
      end
      riscv_instr::P_SH_RR: begin      // Xpulpimg: p.sh
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error occur 43");
        end
      end
      riscv_instr::P_SW_RR: begin      // Xpulpimg: p.sw
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error occur44 ");
        end
      end
      // Immediate branching
      riscv_instr::P_BEQIMM: begin // Xpulpimg: p.beqimm
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error occur 45");
        end
      end
      riscv_instr::P_BNEIMM: begin // Xpulpimg: p.bneimm
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error occur46 ");
        end
      end
      // Off-load to IPU coprocessor
      // 1 source register (rs1)
      ...
      riscv_instr::PV_DOTSP_SCI_B: begin // Xpulpimg: pv.dotsp.sci.b
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error occur 47");
        end
      end
      // 2 source registers (rs1, rs2)
      ...
      riscv_instr::PV_DOTSP_SC_B: begin // Xpulpimg: pv.dotsp.sc.b
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error occur48 ");
        end
      end
      ...
      riscv_instr::PV_SDOTSP_SCI_B: begin // Xpulpimg: pv.sdotsp.sci.b
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error occur49 ");
        end
      end
      ...
      riscv_instr::PV_PACK_H: begin      // Xpulpimg: pv.pack.h
        if (snitch_pkg::XPULPIMG) begin
          ...
          illegal_inst = 1'b1;$display("error occur 50");
        end
      end
`endif
...
/* Floating point instructions */
      ...
      riscv_instr::FNMADD_D: begin
        if (FP_EN && RVD && (!(inst_data_i inside {riscv_instr::FDIV_D, riscv_instr::FSQRT_D}) || XDivSqrt)) begin
          ...
          illegal_inst = 1'b1;$display("error occur52");
        end
      end
      ...
      riscv_instr::FCVT_D_S: begin
        if (FP_EN && RVF && (!(inst_data_i inside {riscv_instr::FDIV_S, riscv_instr::FSQRT_S}) || XDivSqrt)) begin
          ...
          illegal_inst = 1'b1;$display("error occur53");
        end
      end
      ...
      riscv_instr::FMAX_H: begin
        if (FP_EN && XF16 && fcsr_q.fmode.dst == 1'b0 &&
          ...
          illegal_inst = 1'b1;$display("error occur54");
        end
      end
      riscv_instr::FCVT_S_H: begin
        if (FP_EN && RVF && XF16 && fcsr_q.fmode.src == 1'b0) begin
          ...
          illegal_inst = 1'b1;$display("error occur55");
        end
      end
      riscv_instr::FCVT_H_S: begin
        if (FP_EN && RVF && XF16 && fcsr_q.fmode.dst == 1'b0) begin
          ...
          illegal_inst = 1'b1;$display("error occur56");
        end
      end
      riscv_instr::FCVT_D_H: begin
        if (FP_EN && RVD && XF16 && fcsr_q.fmode.src == 1'b0) begin
          ...
          illegal_inst = 1'b1;$display("error oc57cur");
        end
      end
      riscv_instr::FCVT_H_D: begin
        if (FP_EN && RVD && XF16 && fcsr_q.fmode.dst == 1'b0) begin
          ...
          illegal_inst = 1'b1;$display("error occu58r");
        end
      end
      ...
      riscv_instr::FNMADD_B: begin
        if (FP_EN && XF8 && fcsr_q.fmode.dst == 1'b0 && (!(inst_data_i inside {riscv_instr::FDIV_B, riscv_instr::FSQRT_B}) || XDivSqrt)) begin
          ...
          illegal_inst = 1'b1;$display("error occur59");
        end
      end
        ...
        if (FP_EN) begin
          if ((XF16 && fcsr_q.fmode.src == 1'b0) ||
            ...
            if ((XF8 && fcsr_q.fmode.dst == 1'b0) ||
              ...
              illegal_inst = 1'b1;$display("error occur60");
            end
          end else begin
            illegal_inst = 1'b1;$display("error occu61r");
          end
        end else begin
          illegal_inst = 1'b1;$display("error 62occur");
        end
      end
        ...
        if (FP_EN) begin
          if ((XF8 && fcsr_q.fmode.src == 1'b0) ||
            ...
            if ((XF16 && fcsr_q.fmode.dst == 1'b0) ||
              ...
              illegal_inst = 1'b1;$display("error occur63");
            end
          end else begin
            illegal_inst = 1'b1;$display("error occur64");
          end
        end else begin
          illegal_inst = 1'b1;$display("error occu65r");
        end
      end
      ...
      riscv_instr::FCVT_WU_D: begin
        if (FP_EN && RVD) begin
          ...
          illegal_inst = 1'b1;$display("erro66r occur");
        end
      end
      ...
      riscv_instr::FMV_X_W: begin
        if (FP_EN && RVF) begin
          ...
          illegal_inst = 1'b1;$display("error o67ccur");
        end
      end
      ...
      riscv_instr::FCVT_WU_H: begin
        if (FP_EN && XF16 && fcsr_q.fmode.src == 1'b0) begin
          ...
          illegal_inst = 1'b1;$display("error occ68ur");
        end
      end
      ...
      riscv_instr::FCVT_WU_B: begin
        if (FP_EN && XF8 && fcsr_q.fmode.src == 1'b0) begin
          ...
          illegal_inst = 1'b1;$display("error occ69ur");
        end
      end
      ...
      riscv_instr::FCVT_D_WU: begin
        if (FP_EN && RVD) begin
          ...
          illegal_inst = 1'b1;$display("error occ70ur");
        end
      end
      ...
      riscv_instr::FCVT_H_WU: begin
        if (FP_EN && XF16 && (fcsr_q.fmode.dst == 1'b0)) begin
          ...
          illegal_inst = 1'b1;$display("error occur72");
        end
      end
      ...
      riscv_instr::FCVT_B_WU: begin
        if (FP_EN && XF8 && fcsr_q.fmode.dst == 1'b0) begin
          ...
          illegal_inst = 1'b1;$display("error occu73r");
        end
      end
      ...
      riscv_instr::FLW: begin
        if (FP_EN && RVF) begin
          ...
          illegal_inst = 1'b1;$display("error occ74ur");
        end
      end
      riscv_instr::FSW: begin
        if (FP_EN && RVF) begin
          ...
          illegal_inst = 1'b1;$display("error oc75cur");
        end
      end
      // Double Precision Floating-Point
      riscv_instr::FLD: begin
        if (FP_EN && (RVD || XFVEC)) begin
          ...
          illegal_inst = 1'b1;$display("error occ76ur");
        end
      end
      riscv_instr::FSD: begin
        if (FP_EN && (RVD || XFVEC)) begin
          ...
          illegal_inst = 1'b1;$display("error oc77cur");
        end
      end
      // Half Precision Floating-Point
      riscv_instr::FLH: begin
        if (FP_EN && (XF16 || XF16ALT)) begin
          ...
          illegal_inst = 1'b1;$display("error 78occur");
        end
      end
      ...
      riscv_instr::FLB: begin
        if (FP_EN && (XF8 || XF8ALT)) begin
          ...
          illegal_inst = 1'b1;$display("error oc80cur");
        end
      end
      riscv_instr::FSB: begin
        if (FP_EN && (XF8 || XF8ALT)) begin
          ...
          illegal_inst = 1'b1;$display("error81 occur");
        end
      end
...
/* end of floating point instructions */
      ...
      default: begin
        illegal_inst = 1'b1;$display("error o82ccur");
      end
    endcase
