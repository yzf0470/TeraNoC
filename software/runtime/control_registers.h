...
#define CONTROL_REGISTERS_PARAM_MAX_NUMGROUPS 16
...
#define CONTROL_REGISTERS_WAKE_UP_TILE_MULTIREG_COUNT 16
...
#define CONTROL_REGISTERS_WAKE_UP_GROUP_REG_OFFSET 0x48

// Wake Up Stride Register
#define CONTROL_REGISTERS_WAKE_UP_STRD_REG_OFFSET 0x4c

// Wake Up Offst Register
#define CONTROL_REGISTERS_WAKE_UP_OFFST_REG_OFFSET 0x50

// TCDM Start Address Register
#define CONTROL_REGISTERS_TCDM_START_ADDRESS_REG_OFFSET 0x54

// TCDM End Address Register
#define CONTROL_REGISTERS_TCDM_END_ADDRESS_REG_OFFSET 0x58

// Number of Cores Register
#define CONTROL_REGISTERS_NR_CORES_REG_REG_OFFSET 0x5c

// Read-only cache Enable
#define CONTROL_REGISTERS_RO_CACHE_ENABLE_REG_OFFSET 0x60

// Read-only cache Flush
#define CONTROL_REGISTERS_RO_CACHE_FLUSH_REG_OFFSET 0x64
...
#define CONTROL_REGISTERS_RO_CACHE_START_0_REG_OFFSET 0x68

// Read-only cache Region Start
#define CONTROL_REGISTERS_RO_CACHE_START_1_REG_OFFSET 0x6c

// Read-only cache Region Start
#define CONTROL_REGISTERS_RO_CACHE_START_2_REG_OFFSET 0x70

// Read-only cache Region Start
#define CONTROL_REGISTERS_RO_CACHE_START_3_REG_OFFSET 0x74
...
#define CONTROL_REGISTERS_RO_CACHE_END_0_REG_OFFSET 0x78

// Read-only cache Region End
#define CONTROL_REGISTERS_RO_CACHE_END_1_REG_OFFSET 0x7c

// Read-only cache Region End
#define CONTROL_REGISTERS_RO_CACHE_END_2_REG_OFFSET 0x80

// Read-only cache Region End
#define CONTROL_REGISTERS_RO_CACHE_END_3_REG_OFFSET 0x84
